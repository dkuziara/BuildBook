...
public class BuildBookPageAuthorizationTests
{
    ...
    public void CreateBuildRecordPageDefinesExpectedRouteAndForm()
    {
        ...
        Assert.Contains("NavigationManager.NavigateTo($\"/build-records/{buildRecordId}\")", pageContent);
        Assert.Contains("IOrderIntegrationService", pageContent);
        Assert.Contains("SupplyParameterFromQuery", pageContent);
        Assert.Contains("SourceOrderId", pageContent);
        Assert.Contains("Order Context", pageContent);
    ...
    public void OrderDetailPageDefinesExpectedRouteSectionsAndLinkedTables()
    {
        ...
        Assert.Contains("IOrderWorkflowService", pageContent);
        Assert.Contains("IOrderIntegrationService", pageContent);
        Assert.Contains("IApplicationUserManagementService", pageContent);
        Assert.Contains("ICustomerOptionsReader", pageContent);
        Assert.Contains("IBuildRecordSearchService", pageContent);
        ...
        Assert.Contains("Create Build Record from Order", pageContent);
        Assert.Contains("Search Build Records", pageContent);
