...
public class InfrastructureRegistrationTests
{
    ...
    public void AddBuildBookInfrastructureRegistersDbContextFactory()
    {
        ...
        var orderRegisterCsvExporter = provider.GetRequiredService<IOrderRegisterCsvExporter>();
        var orderRegisterExcelExporter = provider.GetRequiredService<IOrderRegisterExcelExporter>();
        ...
        var orderBoardReader = provider.GetRequiredService<IOrderBoardReader>();
        var orderReportReader = provider.GetRequiredService<IOrderReportReader>();
        var orderReportCsvExporter = provider.GetRequiredService<IOrderReportCsvExporter>();
        ...
        Assert.NotNull(orderRegisterCsvExporter);
        Assert.NotNull(orderRegisterExcelExporter);
        Assert.NotNull(orderRecordCreator);
        Assert.NotNull(orderDetailReader);
        Assert.NotNull(orderBoardReader);
        Assert.NotNull(orderReportReader);
        Assert.NotNull(orderReportCsvExporter);
