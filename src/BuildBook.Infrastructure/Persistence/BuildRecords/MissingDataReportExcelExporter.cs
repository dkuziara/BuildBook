...
public sealed class MissingDataReportExcelExporter(
    IMissingDataReportReader missingDataReportReader) : IMissingDataReportExcelExporter
{
    ...
    private static string BuildWorksheetXml(IReadOnlyList<MissingDataReportRow> rows)
    {
        ...
        AppendRow(builder, 1, [.. MissingDataReportExportProjection.Headers]);

        for (var index = 0; index < rows.Count; index++)
        {
            AppendRow(builder, index + 2, MissingDataReportExportProjection.Project(rows[index]));
        }
    ...
    private const string WorkbookXml =
        ...
        <workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"
          ...
          <sheets>
            <sheet name="Missing Data Report" sheetId="1" r:id="rId1"/>
          </sheets>
        </workbook>
        """;
